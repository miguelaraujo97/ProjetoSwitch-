...
export default function EditProjectPage() {
    ...
    const { createProjectData, typologies, activeProjectCode } = state;
    const { data } = createProjectData;

    const [project, setProject] = useState(createProjectData);

    const match = useMatch('/projects/:projectCode/edit')
    ...
    if (data) {
        return (
            <>
                <TitleHeader
                    title={"Edit Project " + actualProjectCode}
                ...
                <Alert severity="warning">NOT WORKING ONLY FOR ENDPOINT</Alert>
            </>
        );
    } else {
        return "No Data ..."
